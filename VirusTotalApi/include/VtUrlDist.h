...
* @{
*/
VTAPI struct VtUrlDist* VtUrlDist_new(void);

/** Get a reference counter */
VTAPI void VtUrlDist_get(struct VtUrlDist *FileScan);

/** put a reference counter */
VTAPI void VtUrlDist_put(struct VtUrlDist **FileScan);
 ...
 * @return void
 */
VTAPI void VtUrlDist_setApiKey(struct VtUrlDist *vt_udist, const char *api_key);
 ...
 * @return void
 */
VTAPI void VtUrlDist_setAllInfo(struct VtUrlDist *vt_udist, bool value);
 ...
 * @return void
 */
VTAPI void VtUrlDist_setAfter(struct VtUrlDist *vt_udist, unsigned long long value);
 ...
 * @return void
 */
VTAPI void VtUrlDist_setBefore(struct VtUrlDist *vt_udist, unsigned long long value);
 ...
 * @return void
 */
VTAPI void VtUrlDist_setLimit(struct VtUrlDist *vt_udist, int value);

VTAPI struct VtResponse * VtUrlDist_getResponse(struct VtUrlDist *vt_udist);
/**
...
VTAPI int VtUrlDist_getDistribution(struct VtUrlDist *vt_udist);
 ...
 * @return int
 */
VTAPI int VtUrlDist_parse(struct VtUrlDist* url_dist, VtUrlDistCb, void *user_data);
 ...
 * @return int
 */
VTAPI int VtUrlDist_process(struct VtUrlDist* url_dist, VtUrlDistCb, void *user_data);
