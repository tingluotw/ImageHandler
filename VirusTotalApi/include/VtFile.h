 ...
 */
VTAPI struct VtFile* VtFile_new(void);
 ...
 * @return void
 */
VTAPI void VtFile_get(struct VtFile *FileScan);
 ...
 * @return void
 */
VTAPI void VtFile_put(struct VtFile **FileScan);
 ...
 * @return void
 */
VTAPI void VtFile_setApiKey(struct VtFile *file_obj, const char *api_key);
 ...
 * @return void
 */
VTAPI void VtFile_setOffset(struct VtFile *file_obj, const char *offset);
 ...
 * @return void
 */
VTAPI void VtFile_setProgressCallback(struct VtFile *file,
 ...
 * @return void
 */
VTAPI void VtFile_getProgress(struct VtFile *file, int64_t *dltotal, int64_t *dlnow, int64_t *ul_total, int64_t *ul_now);
...
VTAPI void VtFile_cancelOperation(struct VtFile* file);
 ...
 * @return int
 */
VTAPI int VtFile_scan(struct VtFile *file_obj, const char *file_path, const char *notify_url);
 ...
 * @return int
 */
VTAPI int VtFile_rescanHash(struct VtFile *file_obj, const char *hash,
...
VTAPI int VtFile_rescanDelete(struct VtFile *file_obj,
                        const char *hash);
 ...
 * @return int
 */
VTAPI int VtFile_report(struct VtFile *file_obj, const char *resource);

VTAPI struct VtResponse * VtFile_getResponse(struct VtFile *file_obj);
 ...
 * @return int
 */
VTAPI int VtFile_search(struct VtFile *file_obj, const char *query,
 ...
 */
VTAPI int VtFile_clusters(struct VtFile *file_obj, const char *cluster_date,
 ...
 * @return int.  0 for OK or error code
 */
VTAPI int VtFile_download(struct VtFile *file_obj, const char *hash,
 ...
 * @return int
 */
VTAPI int VtFile_downloadToFile(struct VtFile *file_obj, const char *hash, const char *out_file);



VTAPI int VtFile_uploadUrl(struct VtFile *file, char **url);

VTAPI int VtFile_scanBigFile(struct VtFile *file_scan, const char * path);
