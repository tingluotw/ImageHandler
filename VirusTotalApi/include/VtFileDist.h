...
VTAPI struct VtFileDist* VtFileDist_new(void);
 ...
 * @return void
 */
VTAPI void VtFileDist_get(struct VtFileDist *obj);
 ...
 * @return void
 */
VTAPI void VtFileDist_put(struct VtFileDist **obj);
 ...
 * @return void
 */
VTAPI void VtFileDist_setApiKey(struct VtFileDist *vt_dist, const char *api_key);
 ...
 * @return void
 */
VTAPI void VtFileDist_setReports(struct VtFileDist *vt_dist, bool value);
 ...
 * @return void
 */
VTAPI void VtFileDist_setAfter(struct VtFileDist *vt_dist, unsigned long long  value);
 ...
 * @return void
 */
VTAPI void VtFileDist_setBefore(struct VtFileDist *vt_dist, unsigned long long  value);
 ...
 * @return void
 */
VTAPI void VtFileDist_setLimit(struct VtFileDist *vt_dist, int value);
 ...
 * @return VtResponse*
 */
VTAPI struct VtResponse * VtFileDist_getResponse(struct VtFileDist *vt_dist);
...
VTAPI int VtFileDist_getDistribution(struct VtFileDist *vt_dist);
 ...
 */
VTAPI int VtFileDist_process(struct VtFileDist* vt_dist, VtFileDistCb, void *user_data);
