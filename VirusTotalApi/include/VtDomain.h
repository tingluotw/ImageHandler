...
* @{
*/
VTAPI struct VtDomain* VtDomain_new(void);
 ...
 * @return void
 */
VTAPI void VtDomain_get(struct VtDomain *obj);
 ...
 * @return void
 */
VTAPI void VtDomain_put(struct VtDomain **obj);
 ...
 * @return void
 */
VTAPI void VtDomain_setApiKey(struct VtDomain *vt_domain, const char *api_key);
 ...
 * @return VtResponse*
 */
VTAPI struct VtResponse * VtDomain_getResponse(struct VtDomain *vt_domain);
 ...
 */
VTAPI int VtDomain_report(struct VtDomain *vt_domain, const char *domain_name_str);
