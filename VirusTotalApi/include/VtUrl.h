 ...
 * @return VtUrl*
 */
VTAPI struct VtUrl* VtUrl_new(void);
...
VTAPI void VtUrl_get(struct VtUrl *);
 ...
 * @return void
 */
VTAPI void VtUrl_put(struct VtUrl **);
 ...
 * @return void
 */
VTAPI void VtUrl_setApiKey(struct VtUrl *url_scan, const char *api_key);
...
VTAPI int VtUrl_scan(struct VtUrl *, const char *url);
 ...
 * @return int
 */
VTAPI int VtUrl_report(struct VtUrl *, const char *url, bool scan, bool all_info);
 ...
 * @return VtResponse*
 */
VTAPI struct VtResponse * VtUrl_getResponse(struct VtUrl *url_scan);
