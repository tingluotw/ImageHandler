 ...
 */
VTAPI struct VtComments* VtComments_new(void);
 ...
 * @return void
 */
VTAPI void VtComments_get(struct VtComments *vt_comments);
 ...
 * @return void
 */
VTAPI void VtComments_put(struct VtComments **vt_comments);
 ...
 * @return void
 */
VTAPI void VtComments_setApiKey(struct VtComments *vt_comments, const char *api_key);
 ...
 * @return void
 */
VTAPI void VtComments_setBefore(struct VtComments *vt_comments, const char *value);
...
VTAPI int VtComments_setResource(struct VtComments *vt_comments, const char *value);
 ...
 */
VTAPI struct VtResponse * VtComments_getResponse(struct VtComments *vt_comments);
 ...
 * @return int
 */
VTAPI int VtComments_add(struct VtComments *vt_comments, const char *comment);
 ...
 * @return int
 */
VTAPI int VtComments_retrieve(struct VtComments *vt_comments);
