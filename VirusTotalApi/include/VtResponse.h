...
VTAPI struct VtResponse* VtResponse_new(void);
 ...
 * @return void
 */
VTAPI void VtResponse_get(struct VtResponse *VtResponse);
 ...
 * @return void
 */
VTAPI void VtResponse_put(struct VtResponse **VtResponse);
...
VTAPI char * VtResponse_getVerboseMsg(struct VtResponse *response, char *buf, int buf_siz);
 ...
 */
VTAPI int VtResponse_getResponseCode(struct VtResponse *response, int *response_code);
 ...
 */
VTAPI char * VtResponse_toJSONstr(struct VtResponse *response, int flags);
 ...
 * @return int
 */
VTAPI int VtResponse_fromJSONstr(struct VtResponse *response, const char *json_str);
 ...
 * @return int
 */
VTAPI int VtResponse_getIntValue(struct VtResponse *response, const char *key, int *value);
 ...
 */
VTAPI char *VtResponse_getString(struct VtResponse *response, const char *key);
 ...
 * @return json_t*
 */
VTAPI json_t * VtResponse_getJanssonObj(struct VtResponse *response);
