 ...
 */
VTAPI struct VtIpAddr* VtIpAddr_new(void);
 ...
 * @return void
 */
VTAPI void VtIpAddr_get(struct VtIpAddr *obj);
 ...
 * @return void
 */
VTAPI void VtIpAddr_put(struct VtIpAddr **obj);
 ...
 * @return void
 */
VTAPI void VtIpAddr_setApiKey(struct VtIpAddr *vt_ip_addr, const char *api_key);
 ...
 * @return VtResponse*
 */
VTAPI struct VtResponse * VtIpAddr_getResponse(struct VtIpAddr *vt_ip_addr);
 ...
 */
VTAPI int VtIpAddr_report(struct VtIpAddr *vt_ip_addr, const char *ip_addr_str);
