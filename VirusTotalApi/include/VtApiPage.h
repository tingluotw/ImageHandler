 ...
 * @return int.  O for OK
 */
VTAPI int VtApiPage_destructor(struct VtObject *obj);

VTAPI struct VtApiPage* VtApiPage_alloc(struct VtApiPage_ops *ops);

VTAPI struct VtApiPage* VtApiPage_new(void);
 ...
 * @return void
 */
VTAPI void VtApiPage_put(struct VtApiPage **);
 ...
 * @return void
 */
VTAPI void VtApiPage_get(struct VtApiPage *);
 ...
 * @return void
 */
VTAPI void VtApiPage_setApiKey(struct VtApiPage *api, const char *key);
 ...
 * @return size_t
 */
VTAPI size_t __VtApiPage_WriteCb(char *ptr, size_t size, size_t nmemb, void *userdata);
 ...
 * @return void
 */
VTAPI void VtApiPage_resetBuffer(struct VtApiPage *api);
